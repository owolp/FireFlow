 ...
 * @property getAllowPersonalizedAdsValueUseCase The use case for retrieving the value of the "Allow Personalized Ads" setting.
...
class SetAllowPersonalizedAdsUseCase @Inject constructor(
     ...
     *
     * @param enabled The new value of the "Allow Personalized Ads" setting. If null, the value will be determined based on the user's logged-in state.
     */
