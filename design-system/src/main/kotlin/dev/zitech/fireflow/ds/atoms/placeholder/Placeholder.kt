...
fun Modifier.placeholder(
    ...
    val specificColor = if (color.isSpecified) color else PlaceholderDefaults.color()
    val specificShape = shape ?: MaterialTheme.shapes.small
    remember(specificColor, specificShape, highlight) {
        drawWithContent {
