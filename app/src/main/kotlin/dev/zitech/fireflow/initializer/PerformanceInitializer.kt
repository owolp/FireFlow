...
import dev.zitech.analytics.domain.usecase.SetPerformanceCollectionUseCase
import dev.zitech.core.common.domain.scope.AppScopes
import dev.zitech.fireflow.di.InitializerEntryPoint
import javax.inject.Inject

internal class PerformanceInitializer : Initializer<Unit> {

    @Inject
    lateinit var appScopes: AppScopes

    @Inject
    lateinit var setPerformanceCollectionUseCase: SetPerformanceCollectionUseCase
