...
import dev.zitech.fireflow.domain.usecase.InitializeFlagProvidersUseCase
...
internal class FeatureFlagInitializer : Initializer<Unit> {
    ...
    @Inject
    lateinit var initializeFlagProvidersUseCase: InitializeFlagProvidersUseCase

    override fun create(context: Context) {
        InitializerEntryPoint.resolve(context).inject(this)

        appScopes.singletonLaunch {
            initializeFlagProvidersUseCase()
        }
    }
