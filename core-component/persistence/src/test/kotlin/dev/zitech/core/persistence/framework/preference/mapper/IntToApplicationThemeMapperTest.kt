...
internal class IntToApplicationThemeMapperTest {
    ...
    private lateinit var sut: dev.zitech.settings.domain.mapper.IntToApplicationThemeMapper

    @BeforeEach
    fun setup() {
        sut = dev.zitech.settings.domain.mapper.IntToApplicationThemeMapper()
    }
