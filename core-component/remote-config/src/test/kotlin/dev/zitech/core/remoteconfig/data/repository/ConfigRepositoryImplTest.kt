...
internal class ConfigRepositoryImplTest {
    ...
    fun init() = runBlocking {
        // Arrange
        fakeConfigProviderSource.initResult = DataSuccess(Unit)
    ...
    fun getBooleanValue() = runBlocking {
        ...
        // Assert
        assertThat((result as DataSuccess).data).isEqualTo(expectedResult)
    }
    ...
    fun getStringValue() = runBlocking {
        ...
        fakeConfigProviderSource.stringResult = DataSuccess(expectedResult)
