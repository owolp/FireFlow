...
interface ConfigRepository {
    ...
    suspend fun getBooleanConfigs(): List<BooleanConfig>
    suspend fun getDoubleConfigs(): List<DoubleConfig>
    suspend fun getLongConfigs(): List<LongConfig>
    suspend fun getStringConfigs(): List<StringConfig>
